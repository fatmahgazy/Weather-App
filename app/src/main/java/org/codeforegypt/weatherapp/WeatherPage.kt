...
import org.codeforegypt.weatherapp.ui.theme.WeatherAppTheme
        ...
        Card {
            Column (
                ...
                Row (
                    ...
                    WeatherKeyVal(key ="Local Time",data.location.localtime.split("")[1])
                    WeatherKeyVal(key ="Local Date",data.location.localtime.split(" ")[0])
                }
            }
        }
